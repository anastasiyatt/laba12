<template>
        <div id="app">
            ...
            <div>
                <label>Фамилия:</label>
                <input type="text" placeholder="Иванов" v-model="params.secondName"/>
            </div> 
            ...
            <div>
                <label>Имя:</label>
                <input type="text" placeholder="Иван" v-model="params.firstName"/>
            </div>
            ...
            <div>
                ...
                <input type="text" placeholder="Иванович" v-model="params.patronymic"/>
            </div> 
            ...
            <div>
                ...
                <input type="text"  placeholder="89999999999" v-model="params.phone"/>
            </div> 
            ...
            <div>
                <button class="knopka" v-on:click="onAdd()"> Записать </button>
            </div>
